...
This repository contains data and R scripts for data analyses associated with the publication entitled: 'The architectural response of a mediterranean tree to mammalian browsing overwhelms the leaf's chemical and structural responses' by Barral, Bochu, Caries, Gaudry, Lecoq, Lo Bue _et al._ [(year)] (doi).
